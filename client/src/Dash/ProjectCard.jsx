...
function ProjectCard({project, leftFunc}){
    ...
    return(
        ...
        <div className="modal-box p-0 rounded-none m-0 w-9/12 max-w-3xl bg-base shadow-xl">
            ...
            {location.pathname === '/dash' ? <p className="hover:text-white hover:cursor-pointer p-2" onClick={()=>{leftFunc(project.id)}}>DELETE</p> : <p className="hover:text-white hover:cursor-pointer p-2" onClick={()=>{leftFunc(project)}}>COPY</p> }
